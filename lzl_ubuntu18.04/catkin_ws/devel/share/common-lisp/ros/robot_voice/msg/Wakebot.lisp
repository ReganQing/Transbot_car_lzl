...
(cl:defmethod cl:initialize-instance :after ((m <Wakebot>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Wakebot)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_voice-msg:<Wakebot> is deprecated: use robot_voice-msg:Wakebot instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Wakebot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_voice-msg:name-val is deprecated.  Use robot_voice-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Wakebot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_voice-msg:age-val is deprecated.  Use robot_voice-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'sex-val :lambda-list '(m))
(cl:defmethod sex-val ((m <Wakebot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_voice-msg:sex-val is deprecated.  Use robot_voice-msg:sex instead.")
  (sex m))
